...
def plot_graph(df, metric_value):
    # Set up the plot
    ...
    ax.bar(index, df_memory_efficient[metric_value], bar_width, label='Memory Efficient Attention', color='orange')
...
plot_graph(df_duration, "Speed Up")
