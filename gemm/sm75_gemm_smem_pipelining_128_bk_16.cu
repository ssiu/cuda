...
void gemm_smem_pipelining_128_bk_16_kernel(
...
void gemm_smem_pipelining_128_bk_16(half_t* A, half_t* B, float* C, int m, int n, int k) {
...
//     printf("%d\n", prob_shape[2]);
    ...
    dim3 dimBlock(128);
    gemm_smem_pipelining_128_bk_16_kernel<<<dimGrid, dimBlock>>>(prob_shape, cta_tiler,
