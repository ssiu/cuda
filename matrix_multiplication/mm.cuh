...
__global__ void mm_new_8_copy(float* A, float* B, float*C, int N);
...
__global__ void mm_llmc_1(float* A, float* B, float*C, int N);
__global__ void mm_llmc_2(float* A, float* B, float*C, float* bias, int N);
