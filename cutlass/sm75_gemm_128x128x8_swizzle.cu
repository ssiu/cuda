...
template <typename gmemLayoutA, typename smemLayoutA, typename tiledCopyA,
          typename gmemLayoutB, typename smemLayoutB, typename tiledCopyB,
          typename gmemLayoutC, typename tiledMma>
...
// {
    ...
    Tensor gA = make_tensor(make_gmem_ptr(A), gmemLayoutA{});
...
//                                  make_stride(Int<1>{}, Int<8>{}))));
    ...
    using mmaC = decltype(make_tiled_mma(SM75_16x8x8_F32F16F16F32_TN{}));
