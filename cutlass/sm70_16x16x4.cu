...
int main() {
    // 4 quadpairs computing 16x16x4
    static int M = 16;
    static int N = 16;
    static int K = 4;
    // Allocate memory on the host
    thrust::host_vector<half_t> hA(16*4);
    thrust::host_vector<half_t> hB(16*4);
    thrust::host_vector<float> hC(16*16);
