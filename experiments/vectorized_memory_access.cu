...
int main() {
    ...
    device_copy_32_kernel<N><<<128,4>>>(d_in.data().get(), d_out.data().get());
    device_copy_64_kernel<N><<<128,4>>>(d_in.data().get(), d_out.data().get());
    device_copy_128_kernel<N><<<128,4>>>(d_in.data().get(), d_out.data().get());
